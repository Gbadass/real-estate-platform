    ...
    <div>
      ...
      <div>
       <div className="prp"> <Link className="properties" to="/">
        ...
        <div className="prp"><Link className="properties" to="/CreateMerchant">
          C . Merchant
        </Link></div>
        
        
        <div className="prp"><Link className="properties" to="/EditMerchant">
          {" "}
          Edit Merchant
        </Link></div>

        <div className="prp"><Link className="properties" to="/Merchant">
          {" "}
          Merchant
        </Link></div>
       ...
       <div className="prp"> <Link className="properties" to="/EditAgent">
        ...
        <div className="prp"><Link className="properties" to="/CreateProp">
          {" "}
          Create Property        </Link></div>
        ...
        <div className="prp"><Link className="properties" to='/MerchantLogin'> Merchant Login</Link></div>
      </div>
