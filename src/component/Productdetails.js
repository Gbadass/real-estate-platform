...
function Productdetails() {
  ...
  const handleEvent = (e) => {
    ...
    if (name === "" || email === "" || message === "" || date === "" || time01 === "" || time02 === "") {
      setError(true)
      return
    }
    let appointObj = {
        ...
        <div className="third-div">
          ...
          <div className="third-div-innerd2">
            ...
            <div className="agent-divv">
              ...
              <p className="agent-div-p1">Office: 1-222-333-4444</p>
              <p className="agent-div-p2" >Mobile: 1-222-333-4444</p>
              <p className="agent-div-p2">Fax: 1-222-333-4444</p>
              <p className="agent-div-p2">Whatsapp: 1-222-333-4444</p>
              <p className="agent-div-p2">Email: thebotfakaa@gmail.com</p>
              <button className="view-button">View My Listing</button>
              <form action="" className="form001" onSubmit={handleEvent}>
                <label htmlFor="">
                  <p className="name-p">Name</p>
                  <input className="input0001" value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Name" /> <br />
                  {error === true && name === "" ? <span className="span-red">please enter name</span> : null}

                </label>
                <label htmlFor="">
                  <p className="name-p">Email</p>
                  <input className="input0001" value={email} onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Name" /> <br />
                  {error === true && email === "" ? <span className="span-red">please enter email</span> : null}
                </label>
                <label htmlFor="">
